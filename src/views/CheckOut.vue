<template>
  <v-container fluid class="ma-0 pa-0">
    <v-row>
      <v-col cols="7">
        <v-card elevation="0" color="white" style="padding: 60px 40px 0 80px">
          ...
          <v-card-actions class="justify-space-between align-center mb-5">
            <v-btn
              color="#6200ff"
              variant="elevated"
              class="flex-grow-1"
          ...
          <v-divider length="100%" color="black">OR</v-divider>
          <v-card-title
            style="
              font-weight: 700;
              font-size: 12px;
      ...
      <v-col cols="5">
        ...
        >
          <v-card
            ...
            width="100%"
            color="transparent"
            class="d-flex justify-space-between align-center mb-4 pa-2"
          >
            <v-badge
