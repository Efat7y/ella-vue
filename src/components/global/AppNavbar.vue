<template>
  <div class="navbar">
    <v-app-bar color="#02218f" class="py-0" height="fit-content" absolute>
      <v-container fluid>
        <v-row>
          <v-col cols="4">
            <img
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
                ...
                <span style="color: #ffb547" class="mt-1">Wishlist</span>
              </div>
              <div class="wishliste d-flex flex-column align-center">
                <svg
              ...
              <div
                class="wishliste d-flex flex-column align-center"
        ...
        <v-row class="mt-6">
          ...
          <!-- <v-col cols="2"></v-col> -->
          <v-col cols="4" class="d-flex justify-end" style="gap: 50px">
